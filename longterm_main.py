	...
	for basket_elements in longterm[strategy]['basket_elements']:
		...
		for l in indexwise_dict.keys():
			for lookback in longterm[strategy]['lookback']:
				...
				df_final = read_data('/Users/akshaykulkarni/Desktop/WQU/Rawlong/'+str(l)+'_rawlong.xlsx',indexwise_dict[l], from_date, to_date,interval,False,lookback,holdingdays)
				print('data read')
		...
		output_df.to_excel(str(strategy)+'_'+str(basket_elements)+'_elements_eqwt'+'.xlsx')
