...
longterm={}
longterm['weekly']={'lookback':[5,10,20,60,120],'holdingdays':5,'basket_elements':[5]}
longterm['biweekly']={'lookback':[5,10,20,60,120],'holdingdays':10,'basket_elements':[5]}
longterm['monthly']={'lookback':[10,20,60,120,240],'holdingdays':20,'basket_elements':[5]}
longterm['quarterly']={'lookback':[20,60,120,240],'holdingdays':60,'basket_elements':[5]}
longterm['halfyearly']={'lookback':[60,120,240],'holdingdays':120,'basket_elements':[5]}
longterm['yearly']={'lookback':[120,240],'holdingdays':240,'basket_elements':[5]}


indices=['NIFTY REALTY', 'NIFTY INFRA','NIFTY ENERGY','NIFTY FMCG','NIFTY PHARMA','NIFTY BANK','NIFTY AUTO','NIFTY METAL','NIFTY MEDIA','NIFTY IT','NIFTY OIL & GAS']
...
for strategy in longterm:
	...
	for basket_elements in longterm[strategy]['basket_elements']:
		...
		for lookback in longterm[strategy]['lookback']:
			...
			df_final= read_data('/Users/akshaykulkarni/Desktop/WQU/Codes/SECTORS_rawmedium.xlsx',indices, from_date, to_date,interval,False,lookback,holdingdays)
	...
	output_df.to_excel('sectorrotation_5_'+strategy+'_eqwt'+'.xlsx')
