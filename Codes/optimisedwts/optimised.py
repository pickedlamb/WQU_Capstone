...
#----------------------
mediumterm={}
mediumterm['niftymidcap100']={'lookback':120,'holdingdays':10,'basket_elements':10}
mediumterm['niftysmallcap100']={'lookback':120,'holdingdays':10,'basket_elements':10}



holdingdays = mediumterm['niftymidcap100']['holdingdays']
basket_elements = mediumterm['niftymidcap100']['basket_elements']
lookback = mediumterm['niftymidcap100']['lookback']
l='niftysmallcap100'
df_final = read_data('/Users/akshaykulkarni/Desktop/WQU/raw/niftysmallcap100_raw.xlsx',indexwise_dict[l], from_date, to_date,interval,False,lookback,holdingdays)
print('data read')
...
output_df[l]=return_df['afterholding'].apply(lambda x: (x-0.05)/100 +1 )
output_df.to_excel(l+'.xlsx')
...
# longterm['quarterly']={'lookback':[20,60,120,240],'holdingdays':60,'basket_elements':[10,20,25,30]}
# longterm['halfyearly']={'lookback':[60,120,240],'holdingdays':120,'basket_elements':[10,20,25,30]}
# longterm['yearly']={'lookback':[120,240],'holdingdays':240,'basket_elements':[10,20,25,30]}
...
# 				return_df=getbasketreturn(df_final,basket_df,holdingdays,basket_elements)
# 				print('got the returns')
# 				output_df[l+','+str(basket_elements)+' elements']=return_df['afterholding'].apply(lambda x: (x-0.05)/100 +1 )
				
# 		output_df.to_excel(str(strategy)+'_'+str(lookback)+'_days_medium_eqwt'+'.xlsx')
