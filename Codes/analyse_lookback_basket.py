...
foldername='/Users/akshaykulkarni/Desktop/WQU/halfyearlyeqwt'
...
for filename in os.listdir(foldername):
	...
	if filename.endswith(".xlsx"):
		...
		for old_col in df.columns.to_list():
			new_cols.append(old_col+','+str(elements)+' elements')
		df.columns=new_cols
		for col in df.columns.to_list():
			master_df[col]=df[col]

indexfile='/Users/akshaykulkarni/Desktop/WQU/halfyearly_1_elements_medium_indexeqwt.xlsx'
...
ele = '30'
final_df=createsubdf(master_df,'nifty')
ind_df=pd.DataFrame()
...
print(final_df_wo_outliers.head())
...
# plt.show()
print(metrics_df)
metrics_df.to_excel('halfyearly_analysis.xlsx')
